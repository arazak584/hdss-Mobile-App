 ...
 * Use the {@link BirthCViewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BirthCViewFragment extends Fragment {
    ...
    public static BirthCViewFragment newInstance(String uuid) {
        BirthCViewFragment fragment = new BirthCViewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewModel.getView3(outcome.preg_uuid).observe(getViewLifecycleOwner(), data -> {
            if (data != null) {
    ...
    private void save(boolean save, boolean close, OutcomeViewModel outcomeViewModel) {
        ...
        if (save) {
            ...
            Fragment fragment = BirthBViewFragment.newInstance(outcome.preg_uuid);
