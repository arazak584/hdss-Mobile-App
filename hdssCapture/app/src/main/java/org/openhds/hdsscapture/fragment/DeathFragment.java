...
public class DeathFragment extends Fragment {
    ...
    public static DeathFragment newInstance(Individual individual, Residency residency, Location location, Socialgroup socialgroup, CaseItem caseItem, EventForm eventForm) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getParentFragmentManager().setFragmentResultListener("requestKey", this, (requestKey, bundle) -> {
            ...
            if (bundle.containsKey((DeathFragment.DATE_BUNDLES.INSERTDATE.getBundleKey()))) {
                final String result = bundle.getString(DeathFragment.DATE_BUNDLES.INSERTDATE.getBundleKey());
                binding.dthInsertDate.setText(result);
        ...
        binding.buttonDeathInsertDate.setOnClickListener(v -> {
            final Calendar c = Calendar.getInstance();
            DialogFragment newFragment = new DatePickerFragment(DeathFragment.DATE_BUNDLES.INSERTDATE.getBundleKey(), c);
        ...
        binding.buttonSaveClose.setOnClickListener(v -> {
            ...
            final Death death = binding.getDeath();
            individual.setExtId(this.individual.getExtId());

            boolean isExists = false;
            binding.dthIndividualUuid.setError(null);
            binding.dthInsertDate.setError(null);
            binding.dthDeathDate.setError(null);

            if(death.individual_uuid==null){
                isExists = true;
                binding.dthIndividualUuid.setError("Individual Id is Required");
            }

            if(death.insertDate==null){
                isExists = true;
                binding.dthInsertDate.setError("Date of visit is Required");

            }

            if(death.fw_uuid==null){
                isExists = true;
                binding.dthDeathDate.setError("Date of Death is Required");
            }
