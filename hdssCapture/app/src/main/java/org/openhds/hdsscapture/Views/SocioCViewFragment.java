...
import org.openhds.hdsscapture.databinding.FragmentSocioCBinding;
...
public class SocioCViewFragment extends KeyboardFragment {
    ...
    private FragmentSocioCBinding binding;

    public SocioCViewFragment() {
     ...
     */
    //
    public static SocioCViewFragment newInstance(String uuid) {
        SocioCViewFragment fragment = new SocioCViewFragment();
