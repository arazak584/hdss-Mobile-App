...
public class SocioCFragment extends Fragment {
     ...
     */
    //
    public static SocioCFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup) {
        SocioCFragment fragment = new SocioCFragment();
