...
import org.openhds.hdsscapture.fragment.SocioAFragment;
 ...
 * Use the {@link SocioBViewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SocioBViewFragment extends KeyboardFragment {
     ...
     */
    //
    public static SocioBViewFragment newInstance(String uuid) {
        SocioBViewFragment fragment = new SocioBViewFragment();
    ...
    private void save(boolean save, boolean close, HdssSociodemoViewModel viewModel) {
        ...
        if (save) {
            ...
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    SocioAViewFragment.newInstance(hdssSociodemo.uuid)).commit();
        }
