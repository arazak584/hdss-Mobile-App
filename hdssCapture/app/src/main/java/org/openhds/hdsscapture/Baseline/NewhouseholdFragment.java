...
public class NewhouseholdFragment extends DialogFragment {
     ...
     * @return A new instance of fragment NewhouseholdFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NewhouseholdFragment newInstance(Individual individual, Residency residency, Locations locations,Socialgroup socialgroup) {
        NewhouseholdFragment fragment = new NewhouseholdFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNewhouseholdBinding.inflate(inflater, container, false);
        ...
        if(individual.fw_uuid==null){
            binding.getIndividual().fw_uuid = fw;
        }

        if(residency.fw_uuid==null){
            binding.getResidency().fw_uuid = fw;
        }

        if(socialgroup.fw_uuid==null){
            binding.getSocialgroup().fw_uuid = fw;
        }
        ...
        getParentFragmentManager().setFragmentResultListener("requestKey", this, (requestKey, bundle) -> {
            if (bundle.containsKey((NewhouseholdFragment.DATE_BUNDLES.DOB.getBundleKey()))) {
                final String result = bundle.getString(NewhouseholdFragment.DATE_BUNDLES.DOB.getBundleKey());
                binding.dob.setText(result);
            }

            if (bundle.containsKey((NewhouseholdFragment.DATE_BUNDLES.STARTDATE.getBundleKey()))) {
                final String result = bundle.getString(NewhouseholdFragment.DATE_BUNDLES.STARTDATE.getBundleKey());
        ...
        binding.buttonIndividualDob.setOnClickListener(v -> {
            ...
            DialogFragment newFragment = new DatePickerFragment(NewhouseholdFragment.DATE_BUNDLES.DOB.getBundleKey(), c);
            newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
        });

        binding.buttonResidencyStartDate.setOnClickListener(v -> {
            final Calendar c = Calendar.getInstance();
            DialogFragment newFragment = new DatePickerFragment(NewhouseholdFragment.DATE_BUNDLES.STARTDATE.getBundleKey(), c);
            newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
        });
