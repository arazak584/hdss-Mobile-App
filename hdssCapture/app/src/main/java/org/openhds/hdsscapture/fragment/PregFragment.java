...
public class PregFragment extends DialogFragment {
    ...
    public static PregFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup,Pregnancy pregnancy) {
        PregFragment fragment = new PregFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getParentFragmentManager().setFragmentResultListener("requestKey", this, (requestKey, bundle) -> {
            // We use a String here, but any type that can be put in a Bundle is supported
             if (bundle.containsKey((PregFragment.DATE_BUNDLES.RECORDDATE.getBundleKey()))) {
                final String result = bundle.getString(PregFragment.DATE_BUNDLES.RECORDDATE.getBundleKey());
                binding.editTextRecordedDate.setText(result);
            }

            if (bundle.containsKey((PregFragment.DATE_BUNDLES.OUTCOMEDATE.getBundleKey()))) {
                final String result = bundle.getString(PregFragment.DATE_BUNDLES.OUTCOMEDATE.getBundleKey());
                binding.editTextOutcomeDate.setText(result);
            }

            if (bundle.containsKey((PregFragment.DATE_BUNDLES.CLINICDATE.getBundleKey()))) {
                final String result = bundle.getString(PregFragment.DATE_BUNDLES.CLINICDATE.getBundleKey());
                binding.editTextLastClinicVisitDate.setText(result);
            }

            if (bundle.containsKey((PregFragment.DATE_BUNDLES.EXPECTDATE.getBundleKey()))) {
                final String result = bundle.getString(PregFragment.DATE_BUNDLES.EXPECTDATE.getBundleKey());
        ...
        binding.buttonPregStartDate.setOnClickListener(v -> {
            if (!TextUtils.isEmpty(binding.editTextRecordedDate.getText())) {
                ...
                try {
                    ...
                    DialogFragment newFragment = new DatePickerFragment(PregFragment.DATE_BUNDLES.RECORDDATE.getBundleKey(), selectedDate);
                ...
                DialogFragment newFragment = new DatePickerFragment(PregFragment.DATE_BUNDLES.RECORDDATE.getBundleKey(), c);
                newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
            }
        });
        ...
        binding.buttonPregnancyOutcome.setOnClickListener(v -> {
            if (!TextUtils.isEmpty(binding.editTextOutcomeDate.getText())) {
                ...
                try {
                    ...
                    // Create DatePickerFragment with the parsed date
                    DialogFragment newFragment = new DatePickerFragment(PregFragment.DATE_BUNDLES.OUTCOMEDATE.getBundleKey(), selectedDate);
                    newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
                ...
                final Calendar c = Calendar.getInstance();
                DialogFragment newFragment = new DatePickerFragment(PregFragment.DATE_BUNDLES.OUTCOMEDATE.getBundleKey(), c);
                newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
            }
        });
        ...
        binding.buttonLastClinicVisitDate.setOnClickListener(v -> {
            if (!TextUtils.isEmpty(binding.editTextLastClinicVisitDate.getText())) {
                ...
                try {
                    ...
                    // Create DatePickerFragment with the parsed date
                    DialogFragment newFragment = new DatePickerFragment(PregFragment.DATE_BUNDLES.CLINICDATE.getBundleKey(), selectedDate);
                    newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
                ...
                final Calendar c = Calendar.getInstance();
                DialogFragment newFragment = new DatePickerFragment(PregFragment.DATE_BUNDLES.CLINICDATE.getBundleKey(), c);
                newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
            }
        });
        ...
        binding.buttonPregExpectDate.setOnClickListener(v -> {
                final Calendar c = Calendar.getInstance();
                DialogFragment newFragment = new DatePickerFragment(PregFragment.DATE_BUNDLES.EXPECTDATE.getBundleKey(), c);
                newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
        });
        ...
        try {
            Pregnancy data = viewModel.ins(pregnancy.uuid);
            if (data != null) {
...
//        try {
//            Pregnancy datas = viewModel.lastpreg(pregnancy.individual_uuid);
//            if (datas != null) {
    ...
    private void save(boolean save, boolean close, PregnancyViewModel viewModel) {
        ...
        if (close) {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_cluster,
                    PregAdapterFragment.newInstance(locations, socialgroup,individual,pregnancy )).commit();
        }
