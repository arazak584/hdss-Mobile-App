 ...
 * Use the {@link Birth3AFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Birth3AFragment extends Fragment {
    ...
    public static Birth3AFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup) {
        Birth3AFragment fragment = new Birth3AFragment();
            ...
            if (datas != null) {
                ...
                try {
                    ...
                    if (data != null) {
                        ...
                        data.child_idx = AppConstants.CHILD9;
    ...
    private void save(boolean save, boolean close, OutcomeViewModel outcomeViewModel, IndividualViewModel individualViewModel, ResidencyViewModel residencyViewModel) {
        ...
        if (save) {
            ...
            Fragment fragment = Birth3Fragment.newInstance(individual, locations, socialgroup);
