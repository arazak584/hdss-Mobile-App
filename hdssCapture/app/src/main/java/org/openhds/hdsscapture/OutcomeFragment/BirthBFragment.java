 ...
 * Use the {@link BirthBFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BirthBFragment extends Fragment {
    ...
    public static BirthBFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup) {
        BirthBFragment fragment = new BirthBFragment();
    ...
    private void save(boolean save, boolean close, OutcomeViewModel outcomeViewModel, IndividualViewModel individualViewModel, ResidencyViewModel residencyViewModel) {
        ...
        if (save) {
            ...
            Fragment fragment = BirthAFragment.newInstance(individual, locations, socialgroup);
