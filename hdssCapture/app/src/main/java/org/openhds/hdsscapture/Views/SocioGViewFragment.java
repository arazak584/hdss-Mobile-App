...
import org.openhds.hdsscapture.databinding.FragmentSocioGBinding;
...
import org.openhds.hdsscapture.fragment.SocioZFragment;
 ...
 * Use the {@link SocioGViewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SocioGViewFragment extends KeyboardFragment {


    private static final String SOCIAL_ID = "SOCIAL_ID";

    private FragmentSocioGBinding binding;
    private HdssSociodemo hdssSociodemo;
    private HdssSociodemoRepository repository;

    public SocioGViewFragment() {
     ...
     */
    //
    public static SocioGViewFragment newInstance(String uuid) {
        SocioGViewFragment fragment = new SocioGViewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSocioGBinding.inflate(inflater, container, false);
        ...
        loadCodeData(binding.SMOKEINOECDOSFRQ, "FRQ");
        loadCodeData(binding.SMOKEHHOLDINOECDOSFRQ, "FRQ");
    ...
    private void save(boolean save, boolean close, HdssSociodemoViewModel viewModel) {
        ...
        if (save) {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    SocioZViewFragment.newInstance(hdssSociodemo.uuid)).commit();
        }else {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
