 ...
 * Use the {@link SocioFFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SocioFFragment extends KeyboardFragment {
     ...
     */
    //
    public static SocioFFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup) {
        SocioFFragment fragment = new SocioFFragment();
    ...
    private void save(boolean save, boolean close, HdssSociodemoViewModel viewModel) {
        ...
        if (save) {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_cluster,
                    SocioGFragment.newInstance(individual,locations, socialgroup)).commit();
