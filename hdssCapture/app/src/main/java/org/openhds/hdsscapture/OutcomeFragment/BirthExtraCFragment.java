 ...
 * Use the {@link BirthExtraCFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BirthExtraCFragment extends Fragment {
    ...
    public static BirthExtraCFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup) {
        BirthExtraCFragment fragment = new BirthExtraCFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            if (datas != null) {
                ...
                try {
                    final String child_id = selectedIndividual.uuid + AppConstants.CHILD7 + 0 + roundData.roundNumber;
    ...
    private void save(boolean save, boolean close, OutcomeViewModel outcomeViewModel, IndividualViewModel individualViewModel, ResidencyViewModel residencyViewModel) {
        ...
        if (save) {
            ...
            Fragment fragment = BirthExtraBFragment.newInstance(individual, locations, socialgroup);
