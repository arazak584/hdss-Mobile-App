 ...
 * Use the {@link PregnancyOutcomeViewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PregnancyOutcomeViewFragment extends KeyboardFragment {
    ...
    public PregnancyOutcomeViewFragment() {
    ...
    public static PregnancyOutcomeViewFragment newInstance(String uuid) {
        PregnancyOutcomeViewFragment fragment = new PregnancyOutcomeViewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextInputEditText tbirths = binding.getRoot().findViewById(R.id.et_outcomes);
        tbirths.setEnabled(false);
    ...
    private void save(boolean save, boolean close, PregnancyoutcomeViewModel viewModel) {
        ...
        if (save) {
            ...
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    OutcomeViewFragment.newInstance(pregnancyoutcome.uuid,pregnancyoutcome, 1)).commit();
        }else {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
