 ...
 * Use the {@link BirthCFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BirthCFragment extends Fragment {
    ...
    public static BirthCFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup) {
        BirthCFragment fragment = new BirthCFragment();
    ...
    private void save(boolean save, boolean close, OutcomeViewModel outcomeViewModel, IndividualViewModel individualViewModel, ResidencyViewModel residencyViewModel) {
        ...
        if (save) {
            ...
            Fragment fragment = BirthBFragment.newInstance(individual, locations, socialgroup);
