 ...
 */
public class PregnancyFragment extends DialogFragment {
    ...
    public static PregnancyFragment newInstance(Individual individual,Locations locations, Socialgroup socialgroup) {
        ...
        binding.buttonPregStartDate.setOnClickListener(v -> {
            if (!TextUtils.isEmpty(binding.editTextRecordedDate.getText())) {
                ...
                try {
                    ...
                    DialogFragment newFragment = new DatePickerFragment(PregnancyFragment.DATE_BUNDLES.RECORDDATE.getBundleKey(), selectedDate);
        ...
        binding.buttonPregnancyOutcome.setOnClickListener(v -> {
            if (!TextUtils.isEmpty(binding.editTextOutcomeDate.getText())) {
                ...
                try {
                    ...
                    // Create DatePickerFragment with the parsed date
                    DialogFragment newFragment = new DatePickerFragment(PregnancyFragment.DATE_BUNDLES.OUTCOMEDATE.getBundleKey(), selectedDate);
                    newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
        ...
        binding.buttonLastClinicVisitDate.setOnClickListener(v -> {
            if (!TextUtils.isEmpty(binding.editTextLastClinicVisitDate.getText())) {
                ...
                try {
                    ...
                    // Create DatePickerFragment with the parsed date
                    DialogFragment newFragment = new DatePickerFragment(PregnancyFragment.DATE_BUNDLES.CLINICDATE.getBundleKey(), selectedDate);
                    newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
