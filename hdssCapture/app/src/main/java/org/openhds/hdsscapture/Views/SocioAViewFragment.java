 ...
 * Use the {@link SocioAViewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SocioAViewFragment extends KeyboardFragment {
     ...
     */
    //
    public static SocioAViewFragment newInstance(String uuid) {
        SocioAViewFragment fragment = new SocioAViewFragment();
    ...
    private void save(boolean save, boolean close, HdssSociodemoViewModel viewModel) {
        ...
        if (save) {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    SocioBViewFragment.newInstance(hdssSociodemo.uuid)).commit();
        }else {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
