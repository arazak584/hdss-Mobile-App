    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            if (datas != null) {
                ...
                try {
                    final String child_id = selectedIndividual.uuid + AppConstants.CHILD1 + 0 + roundData.roundNumber;
                ...
                //Child2
                try {
                    final String child_id = selectedIndividual.uuid + AppConstants.CHILD2 + 0 + roundData.roundNumber;
                    Outcome data = outcomeViewModel.find(child_id,selectedLocation.uuid);
                    if (data != null) {
                ...
                //Child3
                try {
                    final String child_id = selectedIndividual.uuid + AppConstants.CHILD3 + 0 + roundData.roundNumber;
                    Outcome data = outcomeViewModel.find(child_id,selectedLocation.uuid);
                    if (data != null) {
    ...
    private void save(boolean save, boolean close, PregnancyoutcomeViewModel viewModel, VpmViewModel vpmViewModel) {
        ...
        if (save) {
            ...
            if ((binding.getPregoutcome1() != null && binding.getPregoutcome1().type != null && binding.getPregoutcome1().type == 2) ||
                ...
                vpm.deathPlace = 1;
                vpm.extId = "ST-" + selectedIndividual.getExtId();
