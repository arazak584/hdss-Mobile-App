 ...
 * Use the {@link BaseClusterDialogFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BaseClusterDialogFragment extends DialogFragment {

    private static final String LOC_LOCATION_IDS = "LOC_LOCATION_IDS";

    private Locations locations;

    public BaseClusterDialogFragment() {
    ...
    public static BaseClusterDialogFragment newInstance(Locations locations) {
        BaseClusterDialogFragment fragment = new BaseClusterDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (BaseFragment.selectedLocation != null) {
            compno.setText(BaseFragment.selectedLocation.getCompextId());
        } else {
        ...
        final BaseClusterAdapter adapter = new BaseClusterAdapter(this, locations);
