...
import org.openhds.hdsscapture.databinding.FragmentBasesocialgroupBinding;
 ...
 * Use the {@link BasesocialgroupFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BasesocialgroupFragment extends Fragment {
     ...
     * @return A new instance of fragment BasesocialgroupFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BasesocialgroupFragment newInstance(Individual individual, Residency residency, Locations locations, Socialgroup socialgroup) {
        BasesocialgroupFragment fragment = new BasesocialgroupFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBasesocialgroupBinding.inflate(inflater, container, false);
    ...
    private void save(boolean save, boolean close) {
        ...
        if (save) {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_baseline,
                    BasevisitFragment.newInstance(individual, residency, locations, socialgroup)).commit();
        }else{
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_baseline,
