...
import org.openhds.hdsscapture.databinding.FragmentSocioFBinding;
...
import org.openhds.hdsscapture.fragment.SocioGFragment;
 ...
 * Use the {@link SocioFViewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SocioFViewFragment extends KeyboardFragment {


    private static final String SOCIAL_ID = "SOCIAL_ID";

    private FragmentSocioFBinding binding;
    private HdssSociodemo hdssSociodemo;
    private HdssSociodemoRepository repository;

    public SocioFViewFragment() {
     ...
     */
    //
    public static SocioFViewFragment newInstance(String uuid) {
        SocioFViewFragment fragment = new SocioFViewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loadCodeData(binding.STOVEFCORRES, "STOVE_FCORRES");
        loadCodeData(binding.COOKINGLOCFCORRES, "COOKING_LOC_FCORRES");
    ...
    private void save(boolean save, boolean close, HdssSociodemoViewModel viewModel) {
        ...
        if (save) {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    SocioGViewFragment.newInstance(hdssSociodemo.uuid)).commit();
