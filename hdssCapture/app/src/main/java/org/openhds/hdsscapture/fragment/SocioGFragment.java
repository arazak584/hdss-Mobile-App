 ...
 * Use the {@link SocioGFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SocioGFragment extends KeyboardFragment {
     ...
     */
    //
    public static SocioGFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup) {
        SocioGFragment fragment = new SocioGFragment();
    ...
    private void save(boolean save, boolean close, HdssSociodemoViewModel viewModel) {
        ...
        if (save) {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_cluster,
                    SocioZFragment.newInstance(individual,locations, socialgroup)).commit();
        }else {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_cluster,
