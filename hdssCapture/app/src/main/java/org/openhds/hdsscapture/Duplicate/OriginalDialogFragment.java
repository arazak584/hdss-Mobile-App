 ...
 * Use the {@link OriginalDialogFragment#newInstance} factory method to
...
public class OriginalDialogFragment extends DialogFragment {
    ...
    public static OriginalDialogFragment newInstance(Individual individual, Residency residency, Locations locations, Socialgroup socialgroup) {
        OriginalDialogFragment fragment = new OriginalDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_dup_dialog, container, false);
        ...
        final OriginalAdapter adapter = new OriginalAdapter(this, residency, locations, socialgroup,compno,individid );
