...
public class BirthFragment extends Fragment {
    ...
    public static BirthFragment newInstance(Individual individual, Locations locations, Socialgroup socialgroup) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getParentFragmentManager().setFragmentResultListener("requestKey", this, (requestKey, bundle) -> {
            ...
            if (bundle.containsKey((BirthFragment.DATE_BUNDLES.RECORDDATE.getBundleKey()))) {
                final String result = bundle.getString(BirthFragment.DATE_BUNDLES.RECORDDATE.getBundleKey());
                binding.editTextOutcomeDate.setText(result);
            }

            if (bundle.containsKey((BirthFragment.DATE_BUNDLES.CONCEPTION.getBundleKey()))) {
                final String result = bundle.getString(BirthFragment.DATE_BUNDLES.CONCEPTION.getBundleKey());
        ...
        binding.buttonOutcomeStartDate.setOnClickListener(v -> {
            ...
            DialogFragment newFragment = new DatePickerFragment(BirthFragment.DATE_BUNDLES.RECORDDATE.getBundleKey(), c);
            newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
        });

        binding.buttonOutcomeConception.setOnClickListener(v -> {
            final Calendar c = Calendar.getInstance();
            DialogFragment newFragment = new DatePickerFragment(BirthFragment.DATE_BUNDLES.CONCEPTION.getBundleKey(), c);
            newFragment.show(requireActivity().getSupportFragmentManager(), TAG);
        });
        ...
        try {
            Pregnancyoutcome data = viewModel.findloc(selectedIndividual.uuid, selectedLocation.compno);
            if (data != null) {
                ...
                Pregnancy dts = pregnancyViewModel.out(selectedIndividual.uuid);
                if (dts != null){
    ...
    private void save(boolean save, boolean close, PregnancyoutcomeViewModel viewModel) {
        ...
        if (save) {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_cluster,
                    BirthAFragment.newInstance(individual, locations, socialgroup)).commit();
        }else {
            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container_cluster,
