...
public class BaseFragment extends Fragment {
    ...
    public static BaseFragment newInstance(Hierarchy level6Data) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RecyclerView recyclerView = view.findViewById(R.id.basecompoundsview);
        final BaseAdapter adapter = new BaseAdapter(this, level6Data);
        ...
        final ExtendedFloatingActionButton add_location = view.findViewById(R.id.button_new_locations);
