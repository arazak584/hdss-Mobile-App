 ...
 * Use the {@link FatherOutcomeDialogFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FatherOutcomeDialogFragment extends DialogFragment {
    ...
    public static FatherOutcomeDialogFragment newInstance(Individual individual, Residency residency, Locations locations, Socialgroup socialgroup) {
        FatherOutcomeDialogFragment fragment = new FatherOutcomeDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final FatherOutcomeAdapter adapter = new FatherOutcomeAdapter(this, residency, locations, socialgroup,caseItem );
